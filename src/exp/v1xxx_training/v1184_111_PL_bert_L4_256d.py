...
PSEUDO_LABEL_DIR = KFUJIKAWA_DIR / "v8xxx_ensemble" / "v8004_015_016_v1170_v1174"
...
class ImpressionFeatureExtractor(FeatureExtractor):
    ...
    def fields(self) -> list[FeatureField]:
        return [
            ...
            SinusoidalImpressionFeatureField("inview_elapsed_min"),
...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, _idx) -> dict:
        idx, epoch = _idx
    ...
    def extract_feature(self, split: str, epoch: int, impression_index: int):
